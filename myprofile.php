  ...
  if (isset($_POST['upload'])) {
    ...
    if (in_array($ekstensiGambar,$ekstensiGambarValid))
    {
        if ($size <= 5000000)
        {
           ...
           mysqli_query($conn,"UPDATE profil SET fotoprofil='$target' WHERE email='$active'");
...
<div class="jumbotron"> 
          ...
          <?php while($data=mysqli_fetch_assoc($result)): ?>
            <div class="row text-center">
              ...
              <div class="col ">
                ...
                <a href="hapusakun.php?email=<?=$data["email"]?>"type=submit class="btn btn-danger" onclick="return confirm('Yakin?');" name=delete>Hapus Akun</a>
              </div>
              <!-- end of biodata -->
              ...
              <div class="col text-center">
                ...
                <div class="row justify-content-center">
                  <form method="POST" action="myprofile.php" enctype="multipart/form-data">
                    ...
                    <div class="row mt-2">
                      <div class="col">
                        <button type="submit" class="btn btn-info" name="upload">POST</button>
                      </div>
                    </div>
                  </form>
                </div>
  ...
  <h1 class=text-center> Postingan Anda</h1>

        <div class="container">
          <?php
						$jumlahDataPerHalaman = 2;
						$sql = mysqli_query($conn,"SELECT * FROM detailpost INNER JOIN profil ON detailpost.email = profil.email WHERE profil.email='$active' ORDER BY waktupost DESC");
						$jumlahData = mysqli_num_rows($sql);
						$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
						$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"]: 1;
						$awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;
						
						$tabel = mysqli_query($conn,"SELECT * FROM detailpost INNER JOIN profil ON detailpost.email = profil.email WHERE profil.email='$active' ORDER BY waktupost DESC LIMIT $awalData, $jumlahDataPerHalaman");
											...
											<div class="dropdown-menu dropdown-menu-right komentar">
												...
												<div class="container mb-4 dropdown-item">
													<div class="row justify-content-start ">
														<div class="col-1">
															<img src="res/<?=$userkomen["fotoprofil"]?>" style="width:37px;">
														</div>
														<div class="col-6">
