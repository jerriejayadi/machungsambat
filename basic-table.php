            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="profiledb.php" aria-expanded="false">
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php $result=mysqli_query($conn,"SELECT * FROM profil"); ?>
                                    <?php $x = 1;?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?=$data["jurusan"]?></td>
                                            <td><?=$data["email"]?></td>
                                            <td><a href="admin-delete.php?email=<?=$data["email"]?>"type=submit class="btn btn-danger" onclick="return confirm('Yakin?');" name=delete>Hapus Akun</a></td>
                                        </tr>
                                    <?php $x++;?>
                                    <?php endwhile;?>
                                    </tbody>
